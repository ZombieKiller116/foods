...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="#">Создать пост</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <?=$form->field($model, 'category_id')->dropDownList($categories, ['class' => 'form-control select2'])->label('Категория')?>
                </div>
                ...
                <div class="form-group">
                    <?= $form->field($model, 'description')->textarea(['rows' => '6', 'id' => 'description'])->label('Описание') ?>
                </div>

                <div class="form-group">
                    <?=$form->field($model, 'is_feature')->checkbox([ 'value' => '1', 'class' => 'minimal'])->label('Рекомендовать', ['class' => 'text-uppercase font-weight-bold']);?>
                </div>

                <div class="form-group">
                    <?=$form->field($model, 'is_season')->checkbox([ 'value' => '1', 'class' => 'minimal'])->label('Сезонное', ['class' => 'text-uppercase font-weight-bold']);?>
                </div>

                <div class="form-group">
                    <?= $form->field($model, 'content')->textarea(['id' => 'content'])->label('Содержание поста') ?>
                </div>
